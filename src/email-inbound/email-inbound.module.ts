...
@Module({
  imports: [SharedModule, AuditLogModule, MailboxModule, UserModule, WorkspaceModule, TicketModule, CommentModule, AttachmentModule, EmailRuleModule, OrganizationModule, TypeOrmModule.forFeature([ProcessedEmailModel])],
